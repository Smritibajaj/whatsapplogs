...
import { 
// Actions,
ContactContainer, Header, ImageWrapper, SidebarContainer,
// ThemeIconContainer,
 } from "./styles";
...
export default function Sidebar() {
    ...
    return (<SidebarContainer>
      ...
      <ContactContainer ref={chatCtx.containerRef}>
        <Box pb={10}>
          {chatCtx.inbox.map((inbox) => (<InboxContact key={inbox.id} inbox={inbox} isActive={inbox.id === chatCtx.activeChat?.id} onChangeChat={handleChangeChat}/>))}
